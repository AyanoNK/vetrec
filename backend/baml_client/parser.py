...
class LlmResponseParser:
    ...
    def ExtractTimeline(
        ...
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="ExtractTimeline", llm_response=llm_response, mode="request")
...
class LlmStreamParser:
    ...
    def ExtractTimeline(
        ...
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="ExtractTimeline", llm_response=llm_response, mode="stream")
