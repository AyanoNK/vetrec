...
class BamlSyncClient:
    ...
    def ClassifyTranscript(self, transcript: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ClassifyTranscript", args={
    ...
    def ExtractTimeline(self, transcript: str,
        ...
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            __stream__ = self.stream.ExtractTimeline(transcript=transcript,
                baml_options=baml_options)
            return __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractTimeline", args={
                "transcript": transcript,
            })
...
class BamlStreamClient:
    ...
    def ClassifyTranscript(self, transcript: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ClassifyTranscript", args={
            "transcript": transcript,
        })
    ...
    def ExtractTimeline(self, transcript: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.Timeline, types.Timeline]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractTimeline", args={
            "transcript": transcript,
        })
        return baml_py.BamlSyncStream[stream_types.Timeline, types.Timeline](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ClassifyTranscript(self, transcript: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ClassifyTranscript", args={
            "transcript": transcript,
        }, mode="request")
        return __result__
    def ExtractTimeline(self, transcript: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractTimeline", args={
            "transcript": transcript,
        }, mode="request")
        return __result__
