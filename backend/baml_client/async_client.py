...
class BamlAsyncClient:
    ...
    async def ExtractTimeline(self, transcript: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractTimeline", args={
...
class BamlStreamClient:
    ...
    def ExtractTimeline(self, transcript: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractTimeline", args={
            "transcript": transcript,
        })
...
class BamlHttpRequestClient:
    ...
    async def ExtractTimeline(self, transcript: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractTimeline", args={
            "transcript": transcript,
        }, mode="request")
        return __result__
